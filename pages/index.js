    ...
    return (
        <>
            ...
            <section className="bg-[#121414] text-[#F3F2EE] py-8 px-10">
                <h2 className="dm-serif-display text-[3.5rem] mb-4">
                    Saudações!
                </h2>
                <p className="montserrat text-[1rem] mb-2">
                    Sou o Renan, desenvolvedor frontend, desenvolvedor em C++ e
                    Java e futuro cientista da computação. Possuo conhecimento
                    em tecnologias web como HTML, CSS, Javascript, React,
                    Next.js, DatoCMS, SQL e um pouco de UX/UI. Além disso,
                    possui conhecimento em desenvolvimento de jogos em C++ e
                    aplicações em Java. Comecei meu aprendizado em programação
                    em 2021, entretanto minha paixão pela computação me
                    acompanha desde o berço.
                </p>
                <p className="montserrat text-[1rem] mb-4">
                    Além disso, possuo experiência com Python, e C. Sou um
                    entusiasta de engenharia reversa, linguagens de baixo nível
                    e funcionamento de sistemas operacionais, processadores e
                    circuitos. Atuo como mentor de um projeto escolar de
                    programação, linguagens e jornalismo que fundei no ano de
                    2023. Fui professor de música de um projeto voluntário em
            ...
            <section className="p-10 bg-[#F3F2EE]">
                <div className="w-full flex flex-center flex-row justify-between mb-10 md:flex-col">
                    <div className="w-5/12 md:w-full md:mb-4">
                        <h3 className="montserrat text-2xl font-bold mb-4">
                            SOBRE MIM
                        </h3>
                        <p className="montserrat text-justify">
                            Cursando Bacharelado em Ciência da Computação pela
                            Pontifícia Universidade Católica do Paraná, com mais
                            de 3 anos de experiência em desenvolvimento web.
                            Desejo me especializar em linguagens como Python e
                            C++ e me aprofundar em desenvolvimento nativo,
                            desenvolvimento de sistemas operacionais, otimização
                            de algoritmos e estruturas de dados. Possuo
                            habilidade de aprendizado otimizado em um curto
                            espaço de tempo e desejo cada vez mais expandir meu
            ...
            <section className="text-[#F3F2EE] bg-[#121414] montserrat">
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col-reverse md:flex-col-reverse">
                    ...
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            O Jornal Estudantil Tiradentes é um projeto
                            idealizado por mim, em conjunto com meu ex-professor
                            de Língua Portuguesa, José Cristiano Orrigo.
                        </p>
                        <p className="text-justify">
                            Se trata de um projeto que uniu aspectos de
                            jornalismo e tecnologia, proporcionando aos alunos
                            uma interface simples de manipulação e inserção de
                            conteúdos por sistema de CMS, promovendo a
                            participação e o pensamento crítico dentro da
                            comunidade escolar.
                        </p>
                        <div className="my-6">
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col">
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            BIOHAZRD é um jogo concebido por Victor Valério,
                            Pedro Senes, Dillan Fernandes, Riscala Miguel Fadel
                            Neto e Thomas Steinhausser (colegas da PUCPR),
                            inicialmente desenvolvido em uma engine web
                            denominada <strong>Construct</strong>.
                        </p>
                        <p className="text-justify">
                            Atualmente, trabalho desenvolvendo uma engine
                            própria para o jogo, utilizando <strong>C++</strong>{" "}
                            em conjunto com uma biblioteca multimídia chamada{" "}
                            <strong>SFML</strong> (Simple and Fast Multimedia
                            Library). O objetivo é tornar o jogo otimizado,
                            rodando nativamente em computadores Linux e Windows,
                            também permitindo uma customização e gerenciamento
                            de código mais eficaz.
                        </p>
                        <div className="my-6">
                            <h4 className="font-bold text-center w-full mb-2 sm:mb-4">
                                Tecnologias Utilizadas
                        ...
                        <div className="flex items-center sm:flex-col">
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    window
                                        .open(
                                            "https://github.com/marshmll/rpg-game",
                                            "_blank"
                                        )
                                        .focus();
                                }}
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col-reverse">
                    ...
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            Usando recursos <i>bult-in</i>, criei um protótipo
                            de jogo em Java. Utilizei Swing e recursos como
                            Threads, por exemplo. Além disso, desenvolvi um
                            pequeno criador de mapas em Python, gerando um
                            arquivo de mapa a partir de uma imagem com cores
                            pré-definidas relacionadas a cada tipo de{" "}
                            <i>tile</i>
                        </p>
                        <p className="text-justify">
                            Se trata de um projeto descontinuado, mas que me
                            trouxe conhecimentos enormes em Java e Orientação a
                            Objetos.
                        </p>
                        <div className="my-6">
                            <h4 className="font-bold text-center w-full mb-2 sm:mb-4">
                        ...
                        <div className="flex items-center sm:flex-col">
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    window
                                        .open(
                                            "https://github.com/marshmll/my-game",
                                            "_blank"
                                        )
                                        .focus();
                                }}
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col">
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            O BioQuiz é um aplicativo multimídia aplicado em
                            forma de objeto educacional. O projeto se trata de
                            um quiz que atingiu alunos do ensino médio,
                            abordando o conteúdo de Estruturas Celulares. Em
                            grupo, entrevistamos professores da rede privada e
                            pública de ensino, mapeando as dificuldades comuns
                            dos alunos e implementando uma solução através de um
                            jogo leve, dinâmico e interativo.
                        </p>
                        <p className="text-justify">
                            Para o desenvolvimento do projeto, utilizados a IDE
                            Processing, com linguagem Java associada a
                        ...
                        <div className="flex items-center sm:flex-col">
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    window
                                        .open(
                                            "https://github.com/marshmll/projeto_2",
                                            "_blank"
                                        )
                                        .focus();
                                }}
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col-reverse">
                    ...
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            Pig Runaway Simulator é um jogo de plataforma{" "}
                            <i>side-scroller</i> criado na engine de jogos web
                            Construct 3. No jogo, o personagem principal
                            (Porcorredor) deve conseguir fugir de seu inimigo, O
                            Fazendeiro, e se libertar de um ciclo de lavagem
                            cerebral feita pelo Fazendeiro, se vingando por sua
                            família.
                        </p>
                        <p className="text-justify">
                            Projeto e história idealizado por: Renan Andrade,
                            Ricardo Kucek, Hassan Gazouini, Hussein Gazouini,
                            Murilo Zimerman e Samuel Bottesini.
                        </p>
                        <div className="my-6">
                            <h4 className="font-bold text-center w-full mb-2 sm:mb-4">
                                Tecnologias Utilizadas
                ...
                <article className="bg-[#F3F2EE] text-black flex items-center justify-between py-8 px-10 md:flex-col">
                    <div className="p-6 bg-white w-[48%] rounded-lg border-[1px] border-[#CECECE] border-box md:w-full md:mb-4">
                        ...
                        <p className="text-justify">
                            O sistema de cadastros e gerenciamento de castrações
                            de gatos para a ONG Crazy Cat Gang é um protótipo
                            construído com tecnologias web que propõe uma forma
                            dinâmica e eficiente do gerenciamento de gatos que
                            precisam de castração.
                        </p>
                        <p className="text-justify">
                            Para desenvolver este projeto, utilizamos HTML5,
                            CSS3 e JavaScript moderno, além do uso do Next.js
                            para construir uma API de integração para o sistema,
                            que se conectou com a API DatoCMS.
                        </p>
                        <div className="my-6">
                            <h4 className="font-bold text-center w-full mb-2 sm:mb-4">
                                Tecnologias Utilizadas
